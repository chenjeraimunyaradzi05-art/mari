...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="{{ route('admin.profile-verifications.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
        </div>
                                ...
                                <tbody>
                                    @forelse ($verification->documents as $document)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('admin.profile-verifications.documents.download', [$verification, $document]) }}"
