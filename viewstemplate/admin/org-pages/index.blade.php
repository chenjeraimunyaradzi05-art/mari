            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.organization-pages.create') }}" class="btn btn-primary">
                                    ...
                                    @forelse($pages as $page)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.organization-pages.destroy', $page->id) }}" class="btn btn-sm btn-danger delete-item">
