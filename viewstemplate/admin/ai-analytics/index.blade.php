...
<div class="dashboard-ai-analytics">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 text-end">
            <a href="{{ route('admin.ai-analytics.realtime') }}" class="btn btn-primary me-2">
                <i class="fas fa-broadcast-tower"></i> Real-Time Dashboard
            </a>
            <div class="btn-group me-2">
                <a href="{{ route('admin.ai-analytics.export.pdf') }}" class="btn btn-outline-danger" target="_blank">
                    <i class="fas fa-file-pdf"></i> Export PDF
                </a>
                <a href="{{ route('admin.ai-analytics.export.excel') }}" class="btn btn-outline-success">
