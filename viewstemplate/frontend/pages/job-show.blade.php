          ...
          <div class="single-apply-jobs">
            <div class="row align-items-center">
              ...
              <div class="col-md-7 text-lg-end social-share">
                ...
                <a data-social="pro-network" class="d-inline-block d-middle" href="#" aria-label="Copy professional profile link"><img alt="Share to professional network" src="{{ asset('frontend/assets/imgs/template/icons/share-link.svg') }}"></a>
              </div>
            </div>
          </div>
        </div>
