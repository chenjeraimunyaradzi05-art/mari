...
<div class="ai-job-assistant-widget mb-4">
    <div class="row g-4">
        <div class="col-lg-3 col-md-6">
            <div class="ai-card ai-gradient">
                <div class="ai-icon"><i class="fas fa-magic"></i></div>
                <h5>AI Job Description</h5>
                <p>Generate a professional job description in one click.</p>
                <button type="button" class="btn btn-primary btn-sm" onclick="generateJobDescription()">Generate</button>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="ai-card ai-gradient">
                <div class="ai-icon"><i class="fas fa-dollar-sign"></i></div>
                <h5>AI Salary Suggestion</h5>
                <p>Get market-based salary recommendations instantly.</p>
                <button type="button" class="btn btn-primary btn-sm" onclick="suggestSalary()">Suggest</button>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="ai-card ai-gradient">
                <div class="ai-icon"><i class="fas fa-lightbulb"></i></div>
                <h5>AI Skills Recommendation</h5>
                <p>Discover the most relevant skills for this job.</p>
                <button type="button" class="btn btn-primary btn-sm" onclick="suggestSkills()">Recommend</button>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="ai-card ai-gradient">
                <div class="ai-icon"><i class="fas fa-search"></i></div>
                <h5>AI SEO Optimizer</h5>
                <p>Optimize your job post for maximum visibility.</p>
                <button type="button" class="btn btn-primary btn-sm" onclick="optimizeSEO()">Optimize</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById('editor').value =
        'We are seeking a passionate and skilled professional to join our team. Responsibilities include collaborating with cross-functional teams, driving innovation, and delivering high-quality results. Ideal candidates possess strong communication, problem-solving skills, and a commitment to excellence.';
    Notyf && new Notyf().success('AI-generated job description applied!');
}
function suggestSalary() {
    // Simulate AI salary suggestion
    document.querySelector('[name="min_salary"]').value = '60000';
    document.querySelector('[name="max_salary"]').value = '90000';
    Notyf && new Notyf().success('AI salary suggestion applied!');
}
function suggestSkills() {
    // Simulate AI skills recommendation
    let skills = document.querySelector('[name="skills[]"]');
    if (skills) {
        for (let i = 0; i < skills.options.length; i++) {
            if ([1,2,3].includes(i)) skills.options[i].selected = true;
        }
    }
    Notyf && new Notyf().success('AI skills recommended!');
}
function optimizeSEO() {
    // Simulate SEO optimization
    Notyf && new Notyf().success('SEO score: 92/100. Title length optimal, keywords present, description length ideal.');
}
</script>
