        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-12 mb-50">
                    ...
                    <div class="mb-40">
                        <h4 class="mb-3" style="color: #E91E8C;">AI-Powered Job Skill Suggestions</h4>
                        <div class="card shadow-sm" style="border-radius: 15px;">
                            <div class="card-body">
                                @if($aiJobSuggestions && count($aiJobSuggestions) > 0)
                                    <ul class="list-unstyled mb-0">
                                        @foreach($aiJobSuggestions as $skill)
                                            <li><span style="color: #8B5CF6; font-weight: bold;"><i class="fas fa-lightbulb"></i> {{ $skill }}</span></li>
                                        @endforeach
                                    </ul>
                                @else
                                    <p class="text-muted">No AI skill suggestions available. Update your company info for better recommendations!</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-40">
                        <h4 class="mb-3" style="color: #8B5CF6;">AI-Powered Company Insights</h4>
                        <div class="card shadow-sm" style="border-radius: 15px;">
                            <div class="card-body">
                                @if($companyInsights)
                                    <ul class="list-unstyled">
                                        <li><b>Current Position:</b> {{ $companyInsights['current_position']['current_role'] ?? 'N/A' }}</li>
                                        <li><b>Total Experience:</b> {{ $companyInsights['current_position']['total_experience'] ?? 'N/A' }} years</li>
                                        <li><b>Skill Analysis:</b> {{ $companyInsights['skill_analysis']['summary'] ?? 'N/A' }}</li>
                                        <li><b>Career Progression:</b> {{ $companyInsights['career_progression']['summary'] ?? 'N/A' }}</li>
                                        <li><b>Salary Insights:</b> {{ $companyInsights['salary_insights']['summary'] ?? 'N/A' }}</li>
                                        <li><b>Learning Recommendations:</b> {{ $companyInsights['learning_recommendations']['summary'] ?? 'N/A' }}</li>
                                        <li><b>Industry Trends:</b> {{ $companyInsights['industry_trends']['summary'] ?? 'N/A' }}</li>
                                        <li><b>Next Opportunities:</b> {{ $companyInsights['next_opportunities']['summary'] ?? 'N/A' }}</li>
                                        <li><b>Strengths & Weaknesses:</b> {{ $companyInsights['strength_weakness']['summary'] ?? 'N/A' }}</li>
                                    </ul>
                                @else
                                    <p class="text-muted">No company insights available.</p>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Company Logo <span style="color:#8B5CF6;font-weight:400;">(optional)</span></label>
                                            ...
                                            <small class="text-muted">Recommended size: 200x200px. Leave blank to use default logo.</small>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Company Banner <span style="color:#8B5CF6;font-weight:400;">(optional)</span></label>
                                            <input class="form-control {{ $errors->has('banner') ? 'is-invalid' : '' }}"
                                                type="file" value="" name="banner"
                                                placeholder="Upload your company banner (optional)">
                                            <small class="text-muted">Recommended size: 500x200px. Leave blank to use default banner.</small>
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <form action="{{ route('company.profile.founding-info') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Website <span style="color:#8B5CF6;font-weight:400;">(optional)</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Map Link <span style="color:#8B5CF6;font-weight:400;">(optional)</span></label>
                                            <input type="text" name="map_link" class="form-control ai-address-suggest"
                                                value="{{ $companyInfo?->map_link }}"
                                                placeholder="Paste Google Maps link or start typing address (optional)">
                                            <small class="text-muted">AI-powered address suggestion enabled</small>
                                        </div>
                                    </div>
...
<!-- CKEditor: Only load on pages that need it -->
