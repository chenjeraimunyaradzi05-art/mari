<div class="tab-pane fade show" id="pills-account" role="tabpanel" aria-labelledby="pills-account-tab">
    <form action="{{ route('member.profile.account-info.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
    ...
    <hr class="">
    <div class="mt-4">
        <form action="{{ route('member.profile.account-email.update') }}" method="POST">
            @csrf
    ...
    <hr class="">
    <div class="mt-4">
        <form action="{{ route('member.profile.account-password.update') }}" method="POST">
            @csrf
