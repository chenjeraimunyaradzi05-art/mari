        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="content-university" class="tab-content active">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gradient-to-br from-pink-700 to-rose-800 p-6 rounded-3xl shadow-lg text-white relative overflow-hidden">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="group perspective-container">
                                    <div class="bg-white p-6 rounded-3xl shadow-sm border border-rose-100 hover:shadow-xl hover:border-pink-300 transition-all duration-300 h-full relative overflow-hidden">
                                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-pink-500 to-rose-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
            ...
            <div id="content-apprenticeships" class="tab-content">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gradient-to-br from-rose-500 to-pink-600 rounded-3xl p-8 text-white flex flex-col justify-center items-center text-center">
