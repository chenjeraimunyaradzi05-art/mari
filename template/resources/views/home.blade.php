...
@section('content')
    ...
    @if ($roleSections->isNotEmpty())
        ...
        @php
            $impactAds = $nextSeedAds('home-impact');
        @endphp
            ...
            <div class="container impact-widget__shell">
                <div class="impact-widget__header">
                    ...
                    <div class="impact-widget__meta" aria-live="polite">
                        ...
                        <div class="impact-widget__meta-actions">
                            ...
                            @if(!empty($impactAds))
                                <div class="impact-widget__ad" aria-hidden="false">
                                    <x-ad-slot :ads="$impactAds" position="home-impact" layout="card" />
                                </div>
                            @endif
                        </div>
                    </div>
