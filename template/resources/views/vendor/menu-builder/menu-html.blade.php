{{-- menu-html.blade.php Developer: Munyaradzi Chenjerai --}}
<?php
                        ...
                        <div class="wrap">
                            ...
                            <div class="manage-menus">
                                <form method="get" action="{{ $currentUrl }}">
                                    ...
                                    @if (is_iterable($menulist))
                                        <select name="menu" id="menu" class="menu-select">
                                            <option value="">@lang('menu-builder::messages.select_menu_edit')</option>
                                            @foreach ($menulist as $key => $menuOption)
                                                @php
                                                    $value = is_array($menuOption) ? ($menuOption['id'] ?? $key) : ($menuOption->id ?? $key);
                                                    $label = is_array($menuOption) ? ($menuOption['name'] ?? $menuOption['label'] ?? $value) : ($menuOption->name ?? $menuOption->label ?? $value);
                                                @endphp
                                                <option value="{{ $value }}" @if(request()->input('menu') == $value) selected @endif>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                    @endif
                                                                    ...
                                                                    <p id="menu-item-name-wrap">
                                                                        <label class="howto"
                                                                            ...
                                                                            <select name=""
                                                                                ...
                                                                                <option value="/candidates">Members Page (legacy)</option>
                                                                                <option value="/members">Members Page (/members)</option>
