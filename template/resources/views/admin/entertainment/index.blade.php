...
<section class="section">
    <div class="section-header border-0 bg-transparent px-0 pb-4">
        <div class="d-flex justify-content-between align-items-center w-100">
            ...
            <div>
                <button type="button"  href="{{ route('admin.entertainment.create') }}" class="btn btn-primary btn-lg px-4 shadow-sm rounded-pill">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm py-5">
                        <div class="card-body text-center">
                            ...
                            <button type="button"  href="{{ route('admin.entertainment.create') }}" class="btn btn-primary mt-3">
