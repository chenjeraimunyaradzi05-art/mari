                ...
                <div class="card">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{ route('admin.industry-types.destroy', $type->id) }}" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                    ...
                    <div class="card-footer text-right">
                        <nav class="d-inline-block">
                            @if (is_object($industryTypes) && method_exists($industryTypes, 'hasPages') && $industryTypes->hasPages())
