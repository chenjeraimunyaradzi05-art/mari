                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="pricing">
                            ...
                            width: 100%;">
                                ...
                                <form method="POST" action="{{ route('admin.plans.destroy', $plan->id) }}" class="d-inline w-100">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="w-100 bg-danger text-light delete-item">Delete <i class="fas fa-times"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
