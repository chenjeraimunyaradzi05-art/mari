            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button"  href="{{ route('admin.cities.create') }}" class="btn btn-primary"> <i class="fas fa-plus-circle"></i> Create new</button>
                    </div>
                    ...
                    <div class="card-footer text-right">
                        <nav class="d-inline-block">
                            @if (is_object($cities) && method_exists($cities, 'hasPages') && $cities->hasPages())
