            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button"  href="{{ route('admin.role.create') }}" class="btn btn-primary"> <i class="fas fa-plus-circle"></i> Create new</button>
                    </div>
                                ...
                                @forelse ($roles as $role)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('admin.role.destroy', $role->id) }}" class="d-inline">
                                                @csrf
                                                @method('DELETE')
