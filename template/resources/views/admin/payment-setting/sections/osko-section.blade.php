            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button"  href="{{ route('admin.page-builder.create') }}" class="btn btn-primary"> <i class="fas fa-plus-circle"></i> Create new</button>
                    </div>
                                ...
                                @forelse ($pages as $page)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('admin.page-builder.destroy', $page->id) }}" class="d-inline">
                                                @csrf
                                                @method('DELETE')
