            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button"  href="{{ route('admin.educations.create') }}" class="btn btn-primary"> <i class="fas fa-plus-circle"></i> Create new</button>
                    </div>
                                ...
                                @forelse ($educations as $education)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('admin.educations.destroy', $education->id) }}" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="card-footer text-right">
                        <nav class="d-inline-block">
                            @if (is_object($educations) && method_exists($educations, 'hasPages') && $educations->hasPages())
