                ...
                <div class="card">
                                ...
                                @forelse ($jobExperiences as $experience)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('admin.job-experiences.destroy', $experience->id) }}" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="card-footer text-right">
                        <nav class="d-inline-block">
                            @if (is_object($jobExperiences) && method_exists($jobExperiences, 'hasPages') && $jobExperiences->hasPages())
