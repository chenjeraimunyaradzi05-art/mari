                ...
                <div class="card">
                                ...
                                @forelse ($subscribers as $subscriber)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('admin.newsletter.destroy', $subscriber->id) }}" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="card-footer text-right">
                        <nav class="d-inline-block">
                            @if (is_object($subscribers) && method_exists($subscribers, 'hasPages') && $subscribers->hasPages())
