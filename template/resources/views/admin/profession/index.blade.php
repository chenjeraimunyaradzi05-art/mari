                ...
                <div class="card">
                                ...
                                @forelse ($professions as $profession)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('admin.professions.destroy', $profession->id) }}" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="card-footer text-right">
                        <nav class="d-inline-block">
                            @if (is_object($professions) && method_exists($professions, 'hasPages') && $professions->hasPages())
