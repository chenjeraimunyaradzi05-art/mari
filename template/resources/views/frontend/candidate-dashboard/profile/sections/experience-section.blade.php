        ...
        <tbody class="experience-tbody">
            @forelse ($candidateExperiences as $experience)
                <tr>
                    ...
                    <td>
                        <a href="{{ route("member.experience.edit", $experience->id) }}" class="btn-sm btn btn-primary edit-experience" data-bs-toggle="modal"
                            data-bs-target="#experienceModal"><i class="fas fa-edit"></i></a>
                        <a href="{{ route("member.experience.destroy", $experience->id) }}" class="btn-sm btn btn-danger delete-experience"><i class="fas fa-trash-alt"></i></a>
                    </td>
        ...
        <tbody class="education-tbody">
            @forelse ($candidateEducation as $education)
                <tr>
                    ...
                    <td>
                        <a href="{{ route("member.education.edit", $education->id) }}" class="btn-sm btn btn-primary edit-education" data-bs-toggle="modal"
                            data-bs-target="#educationModal"><i class="fas fa-edit"></i></a>
                        <a href="{{ route("member.education.destroy", $education->id) }}" class="btn-sm btn btn-danger delete-education"><i class="fas fa-trash-alt"></i></a>
                    </td>
