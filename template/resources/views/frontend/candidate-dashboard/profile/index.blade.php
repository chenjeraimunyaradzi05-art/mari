...
<script>
        ...
        function fetchExperience() {
            $.ajax({
                method: 'GET',
                url: "{{ route('member.experience.index') }}",
                data: {},
        ...
        $('#ExperienceForm').on('submit', function(event) {
            ...
            if(editMode){
                $.ajax({
                    method: 'PUT',
                    url: "{{ route('member.experience.update', ':id') }}".replace(':id', editId),
                    data: formData,
                    beforeSend: function() {
                        showLoader();
                    },
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ route('member.experience.store') }}",
                    data: formData,
                    beforeSend: function() {
                        showLoader();
                    },
        ...
        function fetchEducation() {
            $.ajax({
                method: 'GET',
                url: "{{ route('member.education.index') }}",
                data: {},
                success: function(response) {
        ...
        $('#EducationForm').on('submit', function(event) {
            ...
            if(editMode){
                $.ajax({
                    method: 'PUT',
                    url: "{{ route('member.education.update', ':id') }}".replace(':id', editId),
                    data: formData,
                    beforeSend: function() {
                        showLoader();
                    },
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ route('member.education.store') }}",
                    data: formData,
                    beforeSend: function() {
                        showLoader();
                    },
