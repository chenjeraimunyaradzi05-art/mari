<div class="col-lg-3 col-md-4 col-sm-12">
    <div class="box-nav-tabs nav-tavs-profile mb-5">
        <ul class="nav" role="tablist">
            ...
            <li><a class="btn btn-border mb-20" href="{{ route('company.advertising.revenue.index') }}">Ad Revenue Intelligence</a></li>
            <li><a class="btn btn-border mb-20" href="{{ route('company.advertising.slots.index') }}">Ad Slot Readiness</a></li>
