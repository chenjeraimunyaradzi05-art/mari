        ...
        <div class="breacrumb-cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <h2 class="mb-20">{{ $membersLabel }}</h2>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card-grid-2 hover-up">
                                        <div class="card-grid-2-image-left d-flex">
                                            <div class="card-grid-2-image-rd online"><a href="{{ route('members.show', $candidate->slug) }}">
                                                    <figure><img alt="joblist" src="{{ asset($candidate->image) }}">
                                                    </figure>
                                                </a></div>
                                            <div class="card-profile pt-10">
                                                <a href="{{ route('members.show', $candidate->slug) }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6"><span
                                                            class="d-flex justify-content-end align-items-center"><span
                                                                class="font-sm"><a href="{{ route('members.show', $candidate->slug) }}" class="text-primary d-flex align-items-center">Resume <i style="margin-bottom: -4px;" class="fi fi-rr-arrow-right"></i></a></span></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
