...
final class OrderService {
    ...
    static function storeOrder(string $transactionId, string $paymentProvider, string $amount, string $paidInCurrency, string $paymentStatus): void {
        $order = new Order();
    ...
    static function setUserPlan(): void {
