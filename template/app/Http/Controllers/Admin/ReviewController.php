...
final class ReviewController extends Controller
{
     ...
     */
    public function store(ReviewCreateRequest $request): \Illuminate\Http\RedirectResponse
    {
     ...
     */
    public function update(ReviewUpdateRequest $request, string $id): \Illuminate\Http\RedirectResponse
    {
        $imagePath = $this->uploadFile($request, 'image');
