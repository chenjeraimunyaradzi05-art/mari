...
final class JobLocationController extends Controller
{
    use FileUploadTrait;
     ...
     */
    public function store(JobLocationCreateRequest $request): \Illuminate\Http\RedirectResponse
    {
     ...
     */
    public function update(JobLocationUpdateRequest $request, string $id): \Illuminate\Http\RedirectResponse
    {
        $imagePath = $this->uploadFile($request, 'image');
