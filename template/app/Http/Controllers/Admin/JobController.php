...
final class JobController extends Controller
{
     ...
     */
    public function store(JobCreateRequest $request): \Illuminate\Http\RedirectResponse
    {
        // dd($request->all());
     ...
     */
    public function update(JobCreateRequest $request, string $id): \Illuminate\Http\RedirectResponse
    {
        $job = Job::findOrFail($id);
        $job->title = $request->title;
        $job->company_id = $request->company;
