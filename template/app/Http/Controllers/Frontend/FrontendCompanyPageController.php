...
final class FrontendCompanyPageController extends Controller
{
    public function __construct(private readonly CompanyMarketService $marketService)
    {
    }

    function index(Request $request) : View {

        // Check if we need to seed market data
        if (Company::whereNotNull('stock_price')->count() === 0) {
    ...
    public function compare(Request $request): View
    {
        ...
        return view('frontend.pages.company-compare', compact('companies'));
    }
}
