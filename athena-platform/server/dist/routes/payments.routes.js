 ...
 * @access Private
 */
router.get('/methods', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @access Private
 */
router.get('/best-provider', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @access Private
 */
router.post('/process', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 */
router.post('/payout', auth_1.authenticate, (0, roles_1.requireRole)('CREATOR'), async (req, res, next) => {
    try {
        const userId = req.user.id;
 ...
 * @access Private
 */
router.post('/convert', auth_1.authenticate, async (req, res, next) => {
    try {
