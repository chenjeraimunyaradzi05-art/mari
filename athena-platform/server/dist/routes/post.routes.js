...
router.post('/', auth_1.authenticate, [
    (0, express_validator_1.body)('content').isString().notEmpty().isLength({ max: contentSafety_1.CONTENT_LIMITS.post }),
    ...
    try {
        ...
        const content = (0, contentSafety_1.normalizeUserText)(req.body.content, {
            field: 'content',
            maxLength: contentSafety_1.CONTENT_LIMITS.post,
        });
        const mediaUrls = (0, contentSafety_1.normalizeMediaUrls)(req.body.mediaUrls);
        ...
        try {
            ...
            logger_1.logger.warn('AI enrichment skipped', { error: err });
        }
...
router.post('/share', auth_1.authenticate, [
    (0, express_validator_1.body)('title').isString().notEmpty().isLength({ max: contentSafety_1.CONTENT_LIMITS.shareTitle }),
    (0, express_validator_1.body)('url').isString().notEmpty().isLength({ max: 2048 }),
    (0, express_validator_1.body)('entityType').optional().isIn(['job', 'course', 'post', 'video', 'resource']),
    (0, express_validator_1.body)('entityId').optional().isString().isLength({ max: 100 }),
    (0, express_validator_1.body)('message').optional().isString().isLength({ max: contentSafety_1.CONTENT_LIMITS.shareMessage }),
    (0, express_validator_1.body)('description').optional().isString().isLength({ max: contentSafety_1.CONTENT_LIMITS.shareDescription }),
], async (req, res, next) => {
    try {
        const errors = (0, express_validator_1.validationResult)(req);
        if (!errors.isEmpty()) {
        ...
        const title = (0, contentSafety_1.normalizeUserText)(req.body.title, {
            field: 'title',
            maxLength: contentSafety_1.CONTENT_LIMITS.shareTitle,
        });
        const url = (0, contentSafety_1.normalizeSafeUrl)(req.body.url, { field: 'url' });
        const description = (0, contentSafety_1.normalizeOptionalUserText)(req.body.description, {
            field: 'description',
            maxLength: contentSafety_1.CONTENT_LIMITS.shareDescription,
            allowEmpty: true,
        });
        const message = (0, contentSafety_1.normalizeOptionalUserText)(req.body.message, {
            field: 'message',
            maxLength: contentSafety_1.CONTENT_LIMITS.shareMessage,
            allowEmpty: true,
        });
        ...
        if (entityType === 'post' && entityId) {
            await prisma_1.prisma.post.updateMany({
...
router.patch('/:id', auth_1.authenticate, [
    (0, express_validator_1.body)('content').optional().isString().isLength({ max: contentSafety_1.CONTENT_LIMITS.post }),
    (0, express_validator_1.body)('isPublic').optional().isBoolean(),
], async (req, res, next) => {
    try {
        const errors = (0, express_validator_1.validationResult)(req);
        ...
        if (req.body.content !== undefined) {
            data.content = (0, contentSafety_1.normalizeUserText)(req.body.content, {
                field: 'content',
                maxLength: contentSafety_1.CONTENT_LIMITS.post,
            });
        }
        ...
        if (Object.keys(data).length === 0) {
            throw new errorHandler_1.ApiError(400, 'No valid post updates provided');
        }
...
router.post('/:id/comments', auth_1.authenticate, [
    (0, express_validator_1.body)('content').isString().notEmpty().isLength({ max: contentSafety_1.CONTENT_LIMITS.comment }),
