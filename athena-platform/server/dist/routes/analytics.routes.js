 ...
 */
router.get('/platform', auth_1.authenticate, (0, auth_1.requireRole)('ADMIN'), async (req, res, next) => {
    try {
 ...
 */
router.get('/engagement', auth_1.authenticate, (0, auth_1.requireRole)('ADMIN'), async (req, res, next) => {
    try {
 ...
 */
router.get('/top-content', auth_1.authenticate, (0, auth_1.requireRole)('ADMIN'), async (req, res, next) => {
    try {
 ...
 */
router.get('/growth', auth_1.authenticate, (0, auth_1.requireRole)('ADMIN'), async (req, res, next) => {
    try {
        const days = parseInt(req.query.days) || 30;
 ...
 */
router.get('/user/:userId', auth_1.authenticate, (0, auth_1.requireRole)('ADMIN'), async (req, res, next) => {
    try {
 ...
 */
router.get('/dashboard', auth_1.authenticate, (0, auth_1.requireRole)('ADMIN'), async (req, res, next) => {
    try {
 ...
 */
router.get('/creator-dashboard', auth_1.authenticate, (0, auth_1.requireRole)('CREATOR', 'ADMIN'), async (req, res, next) => {
    try {
