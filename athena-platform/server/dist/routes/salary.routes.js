 ...
 * @access Private
 */
router.get('/benchmark', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @access Private
 */
router.get('/range', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @access Private
 */
router.post('/analyze-gap', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 */
router.post('/negotiation-script', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @access Private
 */
router.get('/company/:companyName/transparency', auth_1.authenticate, async (req, res, next) => {
    try {
