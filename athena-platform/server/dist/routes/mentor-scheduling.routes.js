 ...
 * @access Private
 */
router.get('/availability/:mentorProfileId', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 */
router.put('/availability/:mentorProfileId', auth_1.authenticate, async (req, res, next) => {
    try {
        const { mentorProfileId } = req.params;
 ...
 * @access Private (Mentor)
 */
router.get('/sessions/mentor/:mentorProfileId', auth_1.authenticate, async (req, res, next) => {
    try {
        const { mentorProfileId } = req.params;
 ...
 * @access Private
 */
router.get('/sessions/mentee', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @access Private
 */
router.post('/book', auth_1.authenticate, async (req, res, next) => {
    try {
        const menteeId = req.user.id;
 ...
 * @access Private (Mentor)
 */
router.post('/respond/:sessionId', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @access Private
 */
router.post('/cancel/:sessionId', auth_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @access Private (Mentor)
 */
router.post('/complete/:sessionId', auth_1.authenticate, async (req, res, next) => {
    try {
        const mentorUserId = req.user.id;
        const { sessionId } = req.params;
 ...
 */
router.post('/rate/:sessionId', auth_1.authenticate, async (req, res, next) => {
    try {
        const menteeId = req.user.id;
        const { sessionId } = req.params;
