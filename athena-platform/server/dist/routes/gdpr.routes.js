 ...
 */
router.post('/dsar/export', async (req, res, next) => {
    try {
        const userId = req.user.id;
 ...
 */
router.post('/dsar/delete', async (req, res, next) => {
    try {
        const userId = req.user.id;
 ...
 */
router.post('/dsar/rectify', async (req, res, next) => {
    try {
        const userId = req.user.id;
 ...
 */
router.post('/dsar/restrict', async (req, res, next) => {
    try {
        const userId = req.user.id;
 ...
 */
router.put('/consents', async (req, res, next) => {
    try {
        const userId = req.user.id;
 ...
 */
router.post('/consents/:type', async (req, res, next) => {
    try {
        const userId = req.user.id;
 ...
 */
router.get('/cookies/:visitorId', async (req, res, next) => {
    try {
