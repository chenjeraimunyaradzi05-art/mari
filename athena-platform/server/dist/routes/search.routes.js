 ...
 * Search users only
 */
router.get('/users', auth_1.optionalAuth, async (req, res, next) => {
    try {
 ...
 * Search posts only
 */
router.get('/posts', auth_1.optionalAuth, async (req, res, next) => {
    try {
 ...
 * Search jobs only
 */
router.get('/jobs', auth_1.optionalAuth, async (req, res, next) => {
    try {
 ...
 * Search courses only
 */
router.get('/courses', auth_1.optionalAuth, async (req, res, next) => {
    try {
 ...
 * Search videos only
 */
router.get('/videos', auth_1.optionalAuth, async (req, res, next) => {
    try {
 ...
 * Search mentors only
 */
router.get('/mentors', auth_1.optionalAuth, async (req, res, next) => {
    try {
        const { q, page = '1', limit = '20' } = req.query;
        if (!q || typeof q !== 'string') {
            return res.status(400).json({ message: 'Search query is required' });
