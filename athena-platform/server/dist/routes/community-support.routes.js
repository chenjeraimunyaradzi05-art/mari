...
router.post('/programs/:id/enroll', auth_1.authenticate, async (req, res) => {
    try {
        const { id } = req.params;
...
router.patch('/enrollments/:id/milestone', auth_1.authenticate, async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user.id;
...
router.get('/indigenous/communities', async (req, res) => {
    try {
...
router.get('/indigenous/communities/:id', async (req, res) => {
    try {
        const { id } = req.params;
...
router.post('/indigenous/communities/:id/join', auth_1.authenticate, async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user.id;
        const community = await prisma.indigenousCommunityPage.findUnique({
...
router.get('/indigenous/resources', async (req, res) => {
    try {
...
router.get('/language-profile', auth_1.authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
...
router.post('/language-profile', auth_1.authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
...
router.post('/credentials', auth_1.authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
...
router.get('/bridging-programs', async (req, res) => {
    try {
...
router.post('/bridging-programs/:id/enroll', auth_1.authenticate, async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.user.id;
...
router.get('/my/bridging-enrollments', auth_1.authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
