 ...
 */
export declare const httpRequestsTotal: client.Counter<"status" | "method" | "path">;
/**
 * HTTP request duration histogram (seconds).
 * Buckets optimized for typical web latency (5ms to 10s).
 */
export declare const httpRequestDurationSeconds: client.Histogram<"status" | "method" | "path">;
export { client };
