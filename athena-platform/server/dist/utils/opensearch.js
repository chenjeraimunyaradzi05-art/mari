...
exports.deleteDocument = exports.indexDocument = exports.IndexNames = exports.isOpenSearchConnected = exports.getOpenSearchClient = exports.initializeOpenSearch = exports.isOpenSearchEnabled = void 0;
...
const isOpenSearchEnabled = () => process.env.OPENSEARCH_ENABLED === 'true' || !!process.env.OPENSEARCH_NODE;
exports.isOpenSearchEnabled = isOpenSearchEnabled;
const initializeOpenSearch = async () => {
    try {
        if (!(0, exports.isOpenSearchEnabled)()) {
            logger_1.logger.info('OpenSearch disabled; Prisma search fallback is active');
            return false;
        }
        if (!process.env.OPENSEARCH_NODE) {
            logger_1.logger.warn('OPENSEARCH_ENABLED is true but OPENSEARCH_NODE is not set; skipping OpenSearch initialization');
            return false;
        }
...
const isOpenSearchConnected = () => isConnected && !!client;
exports.isOpenSearchConnected = isOpenSearchConnected;
exports.IndexNames = {
    USERS: 'athena_users',
    JOBS: 'athena_jobs',
    POSTS: 'athena_posts',
