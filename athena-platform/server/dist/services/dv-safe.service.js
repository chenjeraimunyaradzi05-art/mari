...
function getDVEncryptionKey() {
    ...
    if (!isValidKey) {
        ...
        return (0, crypto_1.scryptSync)('dev-only-insecure-key', 'athena-dv-salt', 32);
    }
...
function encryptMessage(content) {
    ...
    const cipher = (0, crypto_1.createCipheriv)(ENCRYPTION_ALGORITHM, key, iv, { authTagLength: AUTH_TAG_LENGTH });
...
function decryptMessage(encrypted) {
    ...
    const decipher = (0, crypto_1.createDecipheriv)(ENCRYPTION_ALGORITHM, key, iv, { authTagLength: AUTH_TAG_LENGTH });
