 ...
 */
async function deleteMessage(messageId, userId, options = {}) {
    try {
 ...
 */
async function pinMessage(messageId, pinnedByUserId, isPinned = true) {
    try {
        ...
        logger_1.logger.error('Failed to pin message', { error, messageId });
        throw error;
    }
}
