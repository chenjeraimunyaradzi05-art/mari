...
exports.emailService = exports.sendWelcomeEmail = exports.sendPasswordResetEmail = exports.sendVerificationEmail = exports.sendEmail = void 0;
...
exports.emailService = {
     ...
     */
    async sendWelcomeEmail(to, firstName, referralCode) {
     ...
     */
    async sendReferralNotification(to, referrerName, referredName, credits) {
     ...
     */
    async sendReEngagementEmail(to, firstName, daysInactive) {
     ...
     */
    async sendWeeklyDigest(to, firstName, stats) {
