...
export declare function updateItem(id: string, userId: string, data: {
    sku?: string;
    name?: string;
    description?: string;
    unit?: string;
...
export declare function deleteItem(id: string, userId: string): Promise<{
    name: string;
    id: string;
    createdAt: Date;
    updatedAt: Date;
...
export declare function updateLocation(id: string, userId: string, data: {
    name?: string;
    code?: string;
    address?: string;
    isActive?: boolean;
...
export declare function deleteLocation(id: string, userId: string): Promise<{
    name: string;
    id: string;
    createdAt: Date;
    updatedAt: Date;
...
export declare function updateTransaction(id: string, userId: string, data: {
    locationId?: string;
    type?: 'PURCHASE' | 'SALE' | 'ADJUSTMENT' | 'TRANSFER' | 'RETURN';
    quantity?: number;
    unitCost?: number;
...
export declare function deleteTransaction(id: string, userId: string): Promise<{
    id: string;
    createdAt: Date;
    type: import(".prisma/client").$Enums.InventoryTransactionType;
    reference: string | null;
