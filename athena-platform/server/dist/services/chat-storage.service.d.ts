 ...
 */
export declare function deleteMessage(messageId: string, userId: string, options?: {
 ...
 */
export declare function pinMessage(messageId: string, pinnedByUserId: string, isPinned?: boolean): Promise<any>;
