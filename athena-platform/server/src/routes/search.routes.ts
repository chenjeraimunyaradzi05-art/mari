 ...
 * Search jobs only
 */
router.get('/jobs', optionalAuth, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
      q,
      page = '1',
 ...
 * Search videos only
 */
router.get('/videos', optionalAuth, async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 * Search mentors only
 */
router.get('/mentors', optionalAuth, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { q, page = '1', limit = '20' } = req.query;
