...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      { href: '/wellness', label: 'Wellness', blurb: 'The map of it, and a check you can take before you sign up' },
      { href: '/dashboard/wellness', label: 'Today', blurb: 'A minute for yourself, and the rest of the picture', gated: true },
      { href: '/dashboard/wellness/track', label: 'The health dashboard', blurb: 'Cycle, mood, sleep, movement and water, encrypted', gated: true },
      { href: '/dashboard/wellness/insights', label: 'What the days are saying', blurb: 'Patterns, and a report to hand a doctor', gated: true },
      { href: '/dashboard/wellness/forums', label: 'Forums', blurb: 'Anxiety, low mood, burnout, motherhood, grief; anonymous if you want', gated: true },
      { href: '/dashboard/wellness/circles', label: 'Support circles', blurb: 'Four to six women, one topic, eight weeks', gated: true },
      { href: '/dashboard/wellness/practitioners', label: 'Find care', blurb: 'GPs, psychologists and specialists, rated by real visits', gated: true },
