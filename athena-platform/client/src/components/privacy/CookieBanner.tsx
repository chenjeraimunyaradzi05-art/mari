...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 shadow-lg">
      <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Privacy & Cookies</h3>
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <button
            ...
            className="px-4 py-2 text-xs font-semibold border border-slate-300 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-200"
            disabled={isSaving}
          >
            Reject optional
          </button>
