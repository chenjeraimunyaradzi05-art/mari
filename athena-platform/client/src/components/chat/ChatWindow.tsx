          ...
          return (
            ...
            >
              ...
              >
                ...
                <div className={`text-xs mt-1 flex items-center gap-2 ${isMe ? 'text-blue-100' : 'text-slate-400'}`}>
        ...
        {attachments.length > 0 && (
          <div className="mb-3 grid grid-cols-2 md:grid-cols-4 gap-2">
            {attachments.map((file, index) => (
              <div key={`${file.name}-${index}`} className="relative border border-slate-200 dark:border-slate-700 rounded-lg p-2 text-xs text-slate-600 dark:text-slate-300">
