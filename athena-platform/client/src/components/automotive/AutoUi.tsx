...
const STATUS_WORDS: Record<string, { label: string; tone: 'slate' | 'rose' | 'emerald' | 'amber' | 'sky' }> = {
  ...
  SUBMITTED: { label: 'Submitted', tone: 'amber' }, IN_REVIEW: { label: 'Being read', tone: 'sky' }, PRE_APPROVED: { label: 'Pre-approved', tone: 'emerald' }, EXPIRED: { label: 'Expired', tone: 'slate' }, OPEN: { label: 'Open', tone: 'amber' },
