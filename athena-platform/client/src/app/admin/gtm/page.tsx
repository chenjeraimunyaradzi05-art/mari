      ...
      <header className="bg-white dark:bg-slate-800 shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Go-to-Market</h1>
              <p className="text-slate-600 dark:text-slate-400">Launch planning, growth levers, and market ops</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Keep GTM milestones tracked and accountable.</p>
            </div>
          </div>
