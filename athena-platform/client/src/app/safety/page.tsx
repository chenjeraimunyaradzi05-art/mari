      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 border border-slate-200 dark:border-slate-700">
            ...
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Safety Centre</h3>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 border border-slate-200 dark:border-slate-700">
            ...
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Report a Concern</h3>
            <p className="text-slate-600 dark:text-slate-300 text-sm mb-4">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 border border-slate-200 dark:border-slate-700">
            ...
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Emergency Resources</h3>
            <p className="text-slate-600 dark:text-slate-300 text-sm mb-4">
