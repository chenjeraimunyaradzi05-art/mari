...
const STATIC: Array<[string, Frequency, number]> = [
  ...
  ['/cars', 'weekly', 0.6],
  ['/cars/new', 'weekly', 0.6],
  ['/cars/preloved', 'daily', 0.6],
  ['/cars/mechanics', 'weekly', 0.6],
  ['/cars/finance', 'monthly', 0.5],
  ['/cars/insurance', 'monthly', 0.5],
  ['/cars/value', 'monthly', 0.5],
  ['/cars/safety', 'monthly', 0.5],
  ['/cars/dealerships', 'weekly', 0.4],
  ['/capital', 'monthly', 0.6],
  ['/grants', 'monthly', 0.6],
