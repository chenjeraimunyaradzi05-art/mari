    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-rose-50/40 to-white text-slate-950 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:text-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Our Core Values</h2>
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              <Heart className="w-8 h-8 text-pink-500 mb-4" />
              <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Respect</h3>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Inclusion</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Safety</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Professional networking and career discussions</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Share experiences, seek advice, and build meaningful connections</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Mentorship and support</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Offer guidance, share knowledge, and lift others up</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Constructive feedback and discussions</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Engage respectfully, even when you disagree</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Celebrating achievements</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Share your wins and celebrate others' successes</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Educational content</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Share resources, articles, and learning opportunities</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            {/* Harassment */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-3">Harassment and Bullying</h3>
            ...
            {/* Hate Speech */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-3">Hate Speech and Discrimination</h3>
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            {/* Violence */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-3">Violence and Dangerous Content</h3>
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            {/* Sexual Content */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-3">Sexual and Explicit Content</h3>
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            {/* Fraud */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-3">Fraud and Deception</h3>
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            {/* Spam */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-3">Spam and Manipulation</h3>
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
            ...
            {/* Illegal */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-3">Illegal Activities</h3>
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                ...
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Warning</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">First-time or minor violations may result in a warning and content removal</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                <AlertTriangle className="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Temporary Suspension</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Repeated or moderate violations may result in temporary account suspension (7-30 days)</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                <XCircle className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Permanent Ban</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Severe or repeated violations may result in permanent account termination</p>
                </div>
              </div>
            </div>
        ...
        {/* Appeals */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Appeals Process</h2>
        ...
        {/* Reporting */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">How to Report</h2>
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
            <p className="text-slate-600 dark:text-slate-400 mb-4">
