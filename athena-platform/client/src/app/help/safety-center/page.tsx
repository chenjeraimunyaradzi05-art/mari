          ...
          <div className="bg-pink-50 dark:bg-pink-900/20 rounded-xl p-6 border border-pink-200 dark:border-pink-800">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-slate-800 rounded-lg p-4">
                <h4 className="font-semibold text-slate-900 dark:text-white">Beyond Blue</h4>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-lg p-4">
                <h4 className="font-semibold text-slate-900 dark:text-white">SANE Australia</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400">Support for mental illness and anxiety</p>
