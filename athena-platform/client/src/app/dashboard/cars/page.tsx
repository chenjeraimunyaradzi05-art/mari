      ...
      {o && (
        <>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Panel icon={FileCheck2} title="Finance" intro={o.applications.length ? 'Your saved figures.' : 'No enquiry yet. The public finance page has the arithmetic; start here to save where you stand.'} aside={<Link href="/dashboard/cars/finance" className="btn-ghost text-sm">Open</Link>}>
