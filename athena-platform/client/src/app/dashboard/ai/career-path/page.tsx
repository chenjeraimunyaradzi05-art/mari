        ...
        <div className="card bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-medium text-slate-900 dark:text-white">Timeline Estimates</p>
                <p className="text-sm text-slate-600 dark:text-slate-300">Realistic timeframes for each career transition</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">Key skills and competencies for each level</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <DollarSign className="w-5 h-5 text-primary-500 mt-0.5" />
              <div>
                <p className="font-medium text-slate-900 dark:text-white">Salary Projections</p>
                <p className="text-sm text-slate-600 dark:text-slate-300">Expected compensation at each level</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="max-w-5xl mx-auto p-6 space-y-6">
      ...
      <div className="card bg-gradient-to-r from-primary-50 to-purple-50 dark:from-primary-900/20 dark:to-purple-900/20">
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3 p-3 bg-white dark:bg-slate-800 rounded-lg">
