      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="relative mb-12">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 text-lg border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent shadow-sm"
          />
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {SEARCH_CATEGORIES.map((cat) => (
            <Link
              ...
              className="flex flex-col items-center p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-md transition"
            >
