    ...
    <div className="space-y-6">
      <div className="bg-blue-50 border-l-4 border-blue-600 p-4">
        ...
        <p className="text-gray-700">
          You are running the Next.js proof of concept. This page replaced a Blade template.
        </p>
      </div>
      ...
      {session && (
        <div className="bg-green-50 border border-green-200 rounded p-4">
            ...
            ✅ You are authenticated! Try visiting <Link href="/dashboard" className="font-bold hover:underline">/dashboard</Link>
          </p>
        </div>
      )}
    </div>
